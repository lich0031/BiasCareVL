...
class PromptEncoder(nn.Module):
    ...
    def forward(
        ...
        sparse_embeddings = torch.empty((bs, 0, self.embed_dim), device=self._get_device()) # B,0,256 empty tensor
...
class PromptEncoder(nn.Module):
    ...
    def forward(
        ...
        if text is not None:
            return sparse_embeddings, dense_embeddings, point_embeddings, box_embeddings, text.unsqueeze(1)
        else:
            return sparse_embeddings, dense_embeddings, point_embeddings, box_embeddings, None
